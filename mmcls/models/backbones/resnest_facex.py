...
# https://github.com/JDAI-CV/FaceX-Zoo/blob/5b63794ba7649fe78a29d2ce0d0216c7773f6174/backbone/resnest/resnest.py
...
class ResNeStFaceX(BaseBackbone):
    def __init__(self, num_layers, drop_ratio, feat_dim, out_h=7, out_w=7, init_cfg=None):
