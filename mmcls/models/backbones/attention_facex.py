...
# https://github.com/JDAI-CV/FaceX-Zoo/blob/main/backbone/AttentionNets.py
...
class ResidualAttentionNet(BaseBackbone):
    def __init__(self, stage1_modules, stage2_modules, stage3_modules, feat_dim, out_h, out_w, init_cfg=None):
        super(ResidualAttentionNet, self).__init__(init_cfg)
